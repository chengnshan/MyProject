...
require(['jquery','bootstrap','forms','ajaxfileupload','theme',"moment",'My97DatePicker','datetimepicker'],
    function ($, bootstrap, forms,ajaxfileupload,theme,moment,My97DatePicker,datetimepicker) {
