...
require(['jquery','bootstrap','bootstrap_grid','ajaxfileupload','theme',"moment",'My97DatePicker','datetimepicker'],
    function ($, bootstrap, bootstrap_grid,ajaxfileupload,theme,moment,My97DatePicker,datetimepicker) {
